<template>
    <div class="register-page" :class="{ dark: isDark }">
        <div class="register-card">
            ...
            <div class="badge-label">Create account</div>
            <h1 class="card-title">Join us</h1>
            <p class="card-subtitle">Start your journey with considered shopping.</p>
            ...
            <form v-if="!otpSent" @submit.prevent="requestOtp">
                ...
                <div class="field-group">
                    ...
                    <small class="field-hint">Use the same local number format you will use to log in. Do not include
...
const buildMobileNumber = () => mobileNumber.value.replace(/\D/g, '')
